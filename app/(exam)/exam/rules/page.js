...
export default function ExamRulesPage() {
  ...
  // Get examId from the URL on the client side.
  // This avoids the Next.js useSearchParams() prerendering issue.
  useEffect(() => {
  ...
  useEffect(() => {
    // Wait until the URL has been checked.
    if (examId === null) {
      return;
    }
    ...
    const loadExam = async () => {
      ...
      try {
        ...
        setExam({
          ...
          subject:
            matchedExam.description || "Online Examination",
          ...
          <section className={styles.rulesCard}>
            ...
            <div className={styles.rulesList}>
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>one question</strong> before
                  submitting the exam.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  The examination will be automatically
            ...
            <div className={styles.warning}>
              ...
              <p>
                ...
                connection before starting the examination.
              </p>
            </div>
            ...
            <label className={styles.agreement}>
              ...
              <span>
                I have read and understood all examination
                instructions.
              </span>
            </label>
