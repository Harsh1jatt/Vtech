...
const [previewUrl, setPreviewUrl] = useState(
  ...
  const selectFile = (file) => {
    ...
    if (!ACCEPTED_TYPES.includes(file.type)) {
      onChange(
        null,
        "Certificate file must be a PDF, JPG or PNG."
      );
      return;
    }
     ...
     * The API needs this File when FormData is submitted.
     */
    onChange(
      {
        file,
      ...
      {!value ? (
        <button
          ...
          className={`${styles.uploadDropzone} ${
            dragging ? styles.uploadDragging : ""
          }`}
        ...
        >
          ...
          <span>
            Drag &amp; drop your certificate or click
            to browse
          </span>
