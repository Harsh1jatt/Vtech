...
function normalizeStudent(student) {
  ...
  return {
    ...
    courseStartDate: formatDateForInput(
      student.courseStartDate
    ),

    courseCompletionDate: formatDateForInput(
...
export default function StudentForm({
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      if (!student?._id) {
        router.push(
          `/admin/students/${result.student._id}`
        );
      }
    } catch {
      setErrors({
        ...
        <div className={styles.formGrid}>
          ...
          >
            ...
            <textarea
              ...
              value={values.notes || ""}
              onChange={update}
              placeholder="Add academic or administrative notes"
            />
          </div>
        </div>
      </section>
