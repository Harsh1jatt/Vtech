...
export const CONTACT_EMAIL = "Vtech4186@gmail.com";
export const ADDRESS = "#1326, Prem Vihar, Main Road, Subhash Nagar, Ludhiana";
export const SOCIAL_LINKS = { facebook: "", instagram: "", youtube: "" };
